...
# Read the data
#df = pd.read_csv('detailed_f1_scores_without_context.csv')
df = pd.read_csv('detailed_f1_scores.csv')
...
def create_detailed_heatmap():
    ...
    column_names = {
        ...
        'Positive_F1': 'Pos F1',
        'Neutral_Precision': 'Neu Prec',
        'Neutral_Recall': 'Neu Rec',
        'Neutral_F1': 'Neu F1',
    ...
    plt.title('Detailed Performance Metrics Heatmap with Context', pad=20)
